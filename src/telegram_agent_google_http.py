...
Modified to run on HTTP port 5000 with nginx handling SSL
"""
...
# Add dotenv support for .env file
...
def health():
    ...
    return jsonify({
        ...
        "mode": "http_proxy",
        "services": {
            "groq": "connected" if groq_client else "not_initialized",
            "google_drive": "connected" if drive_service else "not_initialized",
